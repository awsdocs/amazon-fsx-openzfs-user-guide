# Setting up Amazon FSx for OpenZFS<a name="setting-up"></a>
...
To get started using , see [Getting started with Amazon FSx for OpenZFS](getting-started.md) for instructions to create your Amazon FSx resources\.